#!/usr/bin/env python3
"""
Test 3: COCOMO Simulation with config_mdp.yaml

This test runs a COCOMO simulation using MDP (folded protein) mode.
The system consists of TDP43 protein with folded domains.
...
def main():
    """Run COCOMO simulation with config_mdp.yaml."""
    print("\n" + "=" * 60)
    print("COCOMO2 Creator - Test 3: MDP Mode Simulation")
    print("=" * 60 + "\n")
    
    # Configuration
    test_dir = Path(__file__).parent
    config_file = test_dir / "config_mdp.yaml"
    output_dir = test_dir / "output_test3"
    ...
    print("=" * 60)
    print("Starting COCOMO Simulation (MDP Mode)")
    print("=" * 60)
