#!/usr/bin/env python3
"""
Test 5: COCOMO Simulation with config_idp_slab_2comp_tdp43_tdp43.yaml

This test runs a COCOMO simulation with two components:
- TDP43 (MDP/folded protein)
- TDP43_CTD (IDP/unfolded domain)
...
def main():
    """Run COCOMO simulation with config_idp_slab_2comp_tdp43_tdp43.yaml."""
    print("\n" + "=" * 60)
    print("COCOMO2 Creator - Test 5: 2-Component SLAB Simulation")
    print("           (TDP43[MDP] + TDP43_CTD[IDP])")
    print("=" * 60 + "\n")
    
    # Configuration
    test_dir = Path(__file__).parent
    config_file = test_dir / "config_idp_slab_2comp_tdp43_tdp43.yaml"
    output_dir = test_dir / "output_test5"
    ...
    print("=" * 60)
    print("Starting COCOMO Simulation (2-Component Mixed Mode)")
    print("=" * 60)
