#!/usr/bin/env python3
"""
Test 4: COCOMO Simulation with config_idp_slab_2comp_tdp43_fus.yaml

This test runs a COCOMO simulation with two IDP components (TDP43_CTD + SHORT/FUS-like)
in SLAB mode for phase separation study.
...
def main():
    """Run COCOMO simulation with config_idp_slab_2comp_tdp43_fus.yaml."""
    print("\n" + "=" * 60)
    print("COCOMO2 Creator - Test 4: 2-Component SLAB Simulation")
    print("           (TDP43_CTD + FUS)")
    print("=" * 60 + "\n")
    
    # Configuration
    test_dir = Path(__file__).parent
    config_file = test_dir / "config_idp_slab_2comp_tdp43_fus.yaml"
    output_dir = test_dir / "output_test4"
    
    # Simulation parameters
    gpu_id = 0  # Set to -1 for CPU, 0+ for GPU
    preequil_steps = 5000  # Reduced for testing
    simulation_steps = 50000  # Reduced for testing
    ...
    print("=" * 60)
    print("Starting COCOMO Simulation (2-Component SLAB Mode)")
    print("=" * 60)
