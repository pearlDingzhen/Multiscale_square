#!/usr/bin/env python3
"""
Test 2: COCOMO Simulation with config_idp_slab.yaml

This test runs a COCOMO simulation using SLAB mode for phase separation.
The system consists of 50 TDP43_CTD chains in a slab geometry.
...
def main():
    """Run COCOMO simulation with config_idp_slab.yaml."""
    print("\n" + "=" * 60)
    print("COCOMO2 Creator - Test 2: SLAB Mode Simulation")
    print("=" * 60 + "\n")
    
    # Configuration
    test_dir = Path(__file__).parent
    config_file = test_dir / "config_idp_slab.yaml"
    output_dir = test_dir / "output_test2"
    ...
    print("=" * 60)
    print("Starting COCOMO Simulation (SLAB Mode)")
    print("=" * 60)
