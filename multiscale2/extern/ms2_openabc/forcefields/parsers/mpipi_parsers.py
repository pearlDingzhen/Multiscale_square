import numpy as np
import pandas as pd
from multiscale2.extern.ms2_openabc.utils import parse_pdb, write_pdb, atomistic_pdb_to_ca_pdb, build_straight_CA_chain
from multiscale2.extern.ms2_openabc.lib import _amino_acids, _rna_nucleotides, _kcal_to_kj, _angstrom_to_nm
import sys
import os
