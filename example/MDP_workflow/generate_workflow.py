...
def main():
    """Generate workflow scripts for the MDP example."""
    print("="*60)
    print("Multiscale Workflow Generator Example (MDP)")
    print("="*60)
    ...
    if not os.path.exists(config_path):
        ...
        print("Please ensure you are in the example/MDP directory with config.yaml")
        return
...
def test_openmm_script():
    ...
    task_type = config.get('task_type', 'MDP')
