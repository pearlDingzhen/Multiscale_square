#!/usr/bin/env python3
"""
IDR (Intrinsically Disordered Regions) 任务示例运行脚本
演示如何使用multiscale2运行CALVADOS IDR模拟
"""
...
def run_idr_simulation():
    """运行IDR任务模拟"""
    print("="*60)
    print("IDR (Intrinsically Disordered Regions) 任务示例")
    print("="*60)
    ...
    print(f"✓ 生成器初始化成功")
    print(f"  任务类型: {generator.calvados_config.get('task_type', 'IDR')}")
...
def main():
    ...
    print("IDR任务示例")
    print("="*60)
    print("这个示例演示如何运行IDR (Intrinsically Disordered Regions) 任务")
